...
campsiteRouter
  ...
  .put(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      //cribbed shamelessly from WizKidLiz
      .populate("comments.author")
      .then((campsite) => {
        //I suspect the verification goes here but I am unsure how to implement it
        //I was right but had no idea how to get it working. Again, all credit to Liz.
        if (campsite && campsite.comments.id(req.params.commentId)) {
          if (
            campsite.comments
